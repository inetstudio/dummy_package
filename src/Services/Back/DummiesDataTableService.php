...
class DummiesDataTableService extends DataTable implements DummiesDataTableServiceContract
{
    ...
    {
        $transformer = app()->make('InetStudio\Dummies\Contracts\Transformers\Back\DummyTransformerContract');
    ...
    {
        return [
            'url' => route('back.dummies.data.index'),
            'type' => 'POST',
        ];
    }
